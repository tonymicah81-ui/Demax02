        ...
        <Card className="space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button size="sm" onClick={() => { setShowModal('prod'); setFormData({ categoryId: categories[0]?.id || "" }); }} className="gap-1.5 bg-brand-primary text-white text-xs">
        ...
        {showModal && (
          <div className="fixed inset-0 bg-slate-950/50 backdrop-blur-md flex items-center justify-center z-50 p-4">
            <motion.div
              ...
              className="bg-white dark:bg-slate-900 rounded-3xl border border-brand-border dark:border-white/10 shadow-2xl max-w-lg w-full overflow-hidden"
            >
                ...
                {(showModal === 'prod' || showModal === 'sub_model') && (
                  <div className="grid md:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea required value={formData.description || ""} onChange={e => setFormData({ ...formData, description: e.target.value })} className={inp + " min-h-[140px] resize-none"} placeholder="Brief description..." />
                    </div>
                  </div>
                )}
