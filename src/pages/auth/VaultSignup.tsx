    ...
    return (
      <div className="min-h-screen bg-brand-primary dark:bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="max-w-md w-full bg-slate-900 border border-white/5 rounded-3xl p-12 text-center space-y-6 relative z-10"
        >
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mt-3 leading-relaxed">
              Your account has been created and is currently <strong className="text-amber-400">inactive</strong>. A Super Admin must authorize your credentials before you can access the dashboard.
            </p>
          </div>
          ...
          <AnimatePresence mode="wait">
            {error && (
              <motion.div
                ...
                className="p-4 bg-red-950/20 border border-red-900/30 text-red-400 text-[10px] font-black uppercase tracking-widest text-center"
              >
                {error}
              </motion.div>
            )}
