      ...
      >
        ...
        <div className="p-6 sm:p-10 space-y-6">
          <div className="text-center">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white italic uppercase tracking-tighter">Staff Login</h2>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl pl-12 pr-4 py-4 text-sm font-bold text-white focus:outline-none focus:border-brand-accent transition-all placeholder:text-slate-600"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl pl-12 pr-12 py-4 text-sm font-bold text-white focus:outline-none focus:border-brand-accent transition-all placeholder:text-slate-600"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-14 bg-brand-accent hover:bg-brand-accent/90 transition-all text-sm font-black shadow-xl text-white"
            >
