      ...
      >
        <div className="flex flex-col justify-center space-y-8 p-8">
          <div className="inline-flex items-center gap-2 mb-2">
            ...
            <span className="font-extrabold text-xl tracking-tighter text-white uppercase ml-2">
              DUREX <span className="text-brand-success">VAULT</span>
            </span>
          </div>

          <div>
            <h1 className="text-5xl font-black text-white tracking-tighter italic uppercase leading-none">Staff<br />Access_</h1>
            <p className="mt-6 text-slate-400 font-medium text-lg leading-relaxed max-w-sm">
              Secure portal for administrative staff and system managers.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 py-6 border-y border-white/10">
            ...
            <div>
              <p className="text-[10px] font-black text-white uppercase tracking-widest">Vault Security Protocol</p>
        ...
        <div className="grid gap-6">
          <Link to="/company/vault/login">
            ...
            >
              ...
              <div>
                <h2 className="text-2xl font-black text-white italic uppercase tracking-tighter">Staff Login</h2>
          ...
          <Link to="/company/vault/signup">
            ...
            >
              ...
              <div>
                <h2 className="text-2xl font-black text-white italic uppercase tracking-tighter">Staff Registration</h2>
                <p className="text-slate-500 text-xs mt-2 uppercase font-bold tracking-widest">Create a new staff account_</p>
              </div>
